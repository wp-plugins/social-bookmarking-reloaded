...
//  		$this->debug_section();
	...
	function option_other()
	{
		...
		// Label
		$html .= '<p>Display Title (you can put segnala presso, if you use italian): <input type="text" name="sbb_label" value="'.$this->current_settings['sbb_label'].'" /></p>';
          	$html .= '<p>Add string (you can put Aggiungi, if you speak italian): <input type="text" name="target_add" value="'.$this->current_settings['target_add'].'" /></p>';
		$html .= '<p>To word (you can put a, if you use italian): <input type="text" name="target_to" value="'.$this->current_settings['target_to'].'" /></p>';
