...
class social_bookmarks
{
	...
	function social_bookmarks()
	{
		...
		// Default Settings
		$this->default_settings = array('sbb_sites' => 'delicious|digg|furl|blinklist|reddit|feed_me|technorati|yahoo|newsvine|socializer|magnolia|stumbleupon|google|rawsugar|squidoo|spurl|blinkbits|netvouz|rojo|blogmarks|shadows|simpy|comments|scuttle|bloglines|tailrank|scoopeo|blogmemes|blogspherenews|blogsvine|mixx|netscape|ask|smarking|linkagogo|delirious|socialdust|live|slashdot|sphinn|facebook|myspace|healthranker|connotea|barrapunto|twitter|indianpad|bluedot|segnalo|oknotizie|diggita|seotribu|upnews|wikio|notizieflash|kipapa|fai_informazione|bookmark_it|ziczac|plim|technotizie|diggitsport|sbr',							'sbb_label' => 'Segnala presso:',
							'sbb_target' => 'new',
