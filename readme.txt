...
-------------------------------------------------------
Add live.com social, the social bookmarking by Microsoft MSN

Aggiunto il social di live.com -> MSN


What is new in version Social Bookmarking RELOADED 1.91
-------------------------------------------------------
Bugs fixed.
Correzione dei bug.
...
-------------------------------------------------------
Nothing is new this time, I fixed some little bugs and added some infos

Niente di nuovo in questa versione, ho solo corretto piccoli bug e aggiunto qualche informazione in più sul plugin.


New Features in version Social Bookmarking RELOADED 1.8
-------------------------------------------------------
This version has changed the name of plugin. Now is Social Bookmarking RELOADED in order to follow the standard of WP community.
In this version I added SocialDust. Read how to update.
